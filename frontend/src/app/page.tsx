      ...
      <nav className="bg-surface dark:bg-inverse-surface border-b border-outline-variant dark:border-outline w-full z-50 sticky top-0">
        <div className="flex justify-between items-center w-full px-margin py-base max-w-max-width mx-auto">
          <div className="flex items-center gap-2">
            ...
            <span className="text-title-lg font-title-lg font-bold text-primary dark:text-primary-fixed">
              HomeoAssist AI
            </span>
          </div>
          <div className="hidden md:flex flex-1 max-w-xl mx-8 relative">
            ...
            <input
              className="w-full pl-10 pr-4 py-2 border border-outline-variant rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-surface-container-lowest font-body-sm text-body-sm text-on-surface placeholder-on-surface-variant"
              placeholder="Search doctors, medicines, or symptoms..."
              type="text"
            />
          </div>
          <div className="flex items-center gap-6">
            <div className="hidden lg:flex items-center gap-4">
              <a
                className="text-on-surface-variant dark:text-on-secondary-fixed-variant hover:text-primary dark:hover:text-primary-fixed transition-colors font-label-md text-label-md"
                href="#"
              >
                Consult
              </a>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/auth/login"
                className="bg-primary text-on-primary hover:bg-primary-container hover:text-on-primary-container px-6 py-2 rounded-lg font-label-md text-label-md transition-colors shadow-sm"
              >
                Login
              </Link>
            </div>
        ...
        <section className="max-w-max-width mx-auto px-margin py-xl flex flex-col lg:flex-row items-center gap-lg">
          <div className="flex-1 space-y-6">
            <h1 className="text-display-lg font-display-lg text-on-surface">
              Intelligent Homeopathic Care, <br />
              <span className="text-primary">In Your Language.</span>
            </h1>
            <p className="text-body-lg font-body-lg text-on-surface-variant max-w-2xl">
              Consult verified homeopathic specialists powered by AI clinical
              intelligence and get medicines delivered instantly. Experience
              precise, personalized care at your fingertips.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                onClick={() => router.push("/patient/triage")}
                className="bg-primary text-on-primary hover:bg-primary-container hover:text-on-primary-container px-8 py-3 rounded-lg font-label-md text-label-md transition-colors shadow-sm flex items-center justify-center gap-2"
              >
          ...
          <div className="flex-1 relative w-full h-[500px] rounded-xl overflow-hidden shadow-lg border border-outline-variant bg-surface-container-highest">
            <img
              alt="Modern Doctor with Tablet"
              className="w-full h-full object-cover"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuApsHpd-YlR_Em1CvxQ7jmZbyzfZhLShGwTuh-DhJa6M2tV69rVHgZbSDXr3ENB5h1TrUqb6Nr5eS_bwAxVeWtKhxpJFHRG0kMC1t26psuPDadORRZejptKRqoUE110Ed_blfOlJu4y8XHSMwSQ3UfViYeroi9lj0kLbwsBDdyG9j6D_rA_JgDaH4OWmMCDzgC0lNjWg00Dkl6nk6uJugSEZrayTqvEHaOqNd-phM0vAAnsXjS7FqLFlXo1giRJ83JhGdiM7ZM8K8-W"
            />
          </div>
        </section>
        ...
        <section className="max-w-max-width mx-auto px-margin py-xl">
          <div className="mb-lg text-center">
            ...
            <p className="text-body-md font-body-md text-on-surface-variant">
              Everything you need for your homeopathic healthcare journey.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter">
            <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="text-body-sm font-body-sm text-on-surface-variant">
                Connect with experienced homeopathic practitioners for
            ...
            <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="text-body-sm font-body-sm text-on-surface-variant">
                Use our advanced AI to analyze your symptoms and get preliminary
                clinical guidance.
              </p>
            </div>
            <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="text-body-sm font-body-sm text-on-surface-variant">
                Purchase authentic homeopathic remedies directly from our
            ...
            <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="text-body-sm font-body-sm text-on-surface-variant">
                Access a comprehensive Materia Medica and clinical research
